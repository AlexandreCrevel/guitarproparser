...
pub trait SongHeaderOps {
    ...
    fn read_measure_headers(&mut self, data: &[u8], seek: &mut usize, measure_count: usize) -> GpResult<()>;
    fn read_measure_headers_v5(&mut self, data: &[u8], seek: &mut usize, measure_count: usize, directions: &(HashMap<DirectionSign, i16>, HashMap<DirectionSign, i16>)) -> GpResult<()>;
    fn read_measure_header(&mut self, data: &[u8], seek: &mut usize, number: usize, previous: Option<MeasureHeader>) -> GpResult<(MeasureHeader, u8)>;
    fn read_measure_header_v5(&mut self, data: &[u8], seek: &mut usize, number: usize, previous: Option<MeasureHeader>) -> GpResult<(MeasureHeader,u8)>;
    ...
    fn read_directions(&self, data: &[u8], seek: &mut usize) -> GpResult<(HashMap<DirectionSign, i16>, HashMap<DirectionSign, i16>)>;
