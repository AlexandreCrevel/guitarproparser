...
impl Song {
    ...
    pub(crate) fn read_clipboard(&mut self, data: &[u8], seek: &mut usize) -> GpResult<Option<Clipboard>> {
        if !self.version.clipboard {return Ok(None);}
    ...
    pub(crate) fn read_measure_headers(&mut self, data: &[u8], seek: &mut usize, measure_count: usize) -> GpResult<()> {
    ...
    pub(crate) fn read_measure_headers_v5(&mut self, data: &[u8], seek: &mut usize, measure_count: usize, directions: &(HashMap<DirectionSign, i16>, HashMap<DirectionSign, i16>)) -> GpResult<()> {
    ...
    pub(crate) fn read_measure_header(&mut self, data: &[u8], seek: &mut usize, number: usize, previous: Option<MeasureHeader>) -> GpResult<(MeasureHeader, u8)> {
    ...
    pub(crate) fn read_measure_header_v5(&mut self, data: &[u8], seek: &mut usize, number: usize, previous: Option<MeasureHeader>) -> GpResult<(MeasureHeader,u8)> {
    ...
    fn read_repeat_alternative_v5(&mut self, data: &[u8], seek: &mut usize) -> GpResult<u8> {Ok(read_byte(data, seek)?)}
    ...
    /// - Da Coda
    /// - Da Double Coda
    pub(crate) fn read_directions(&self, data: &[u8], seek: &mut usize) -> GpResult<(HashMap<DirectionSign, i16>, HashMap<DirectionSign, i16>)> {
